# Справочник API (Черновик)

> **⚠️ Отказ от ответственности:** Это начальные функции проекта на ранней стадии разработки. Сигнатуры и типы возвращаемых значений могут быть изменены без предварительного уведомления в будущих версиях.
